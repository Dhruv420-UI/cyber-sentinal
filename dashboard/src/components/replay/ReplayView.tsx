        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <select
              ...
              className="w-full sm:w-auto bg-[#0d1424] border border-slate-700 text-slate-200 text-xs rounded-lg px-3 py-2 sm:py-1.5 font-mono focus:outline-none focus:border-blue-500 min-h-[36px]"
            >
              {scenarios.map((s) => (
            ...
            <button
              onClick={handleStart}
              className="flex-1 sm:flex-initial px-3 py-2 sm:py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold transition-colors flex items-center justify-center gap-1.5 min-h-[36px]"
            >
            ...
            <button
              ...
              className="flex-1 sm:flex-initial px-3 py-2 sm:py-1.5 rounded-lg bg-[#152033] hover:bg-[#1f2e48] disabled:opacity-40 text-slate-200 border border-slate-700 text-xs font-bold transition-colors flex items-center justify-center gap-1.5 min-h-[36px]"
            >
            ...
            <button
              ...
              disabled={!sessionId || isComplete}
              className="flex-1 sm:flex-initial px-3 py-2 sm:py-1.5 rounded-lg bg-purple-600/20 hover:bg-purple-600/30 disabled:opacity-40 text-purple-300 border border-purple-500/40 text-xs font-bold transition-colors flex items-center justify-center gap-1.5 min-h-[36px]"
            >
